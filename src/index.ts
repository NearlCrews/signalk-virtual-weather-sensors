...
import { DEFAULT_CONFIG, ERROR_CODES, PLUGIN, TEST_KEY_LOCATION } from './constants/index.js';
...
import type { Logger, PanelStatusResponse, PluginConfiguration } from './types/index.js';
