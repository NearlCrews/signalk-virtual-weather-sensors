...
// Re-export official Signal K server API types
export type {
	Delta,
	PathValue,
	Plugin,
...
/**
 * Logger function type used throughout the plugin
 */
export type Logger = (
	level: LogLevel,
	message: string,
 ...
 */
export function isCompleteWeatherData(
...
export function isCompleteNavigationData(
	...
	Pick<VesselNavigationData, "speedOverGround" | "courseOverGroundTrue">
> &
